export const EXTRA_GAME_IDS = [
  "rock-paper-scissors", "memory-match", "connect-four", "twenty-questions",
  "truth-cards", "story", "cyrene-quiz", "ropebound",
] as const;
...
export interface ScoreStats { played: number; userWins: number; cyreneWins: number; draws: number }
...
export interface GameResult { game: GameId; outcome: GameOutcome; matches?: number }
